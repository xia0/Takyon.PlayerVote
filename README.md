...
| `pv_maps2`                        | Additional cvar because you might reach the limit on pv_maps especially if specifying gamemodes. Do not add leading or trailing comma. Use `pv_maps3` and so on as required. | | string             |
